...
def give_bmi(height: list[int | float], weight: list[int | float]) -> list[int | float]:
	""" return a list of bmi values, given a list of heights and a list of weights """
	try:
		...
		assert list_type == 'int' or list_type == 'float', "list can only be int or float types"
...
def apply_limit(bmi: list[int | float], limit: int) -> list[bool]:
	""" return a list of boolean values, True if bmi is greater than limit, False otherwise """
